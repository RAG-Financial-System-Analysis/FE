  ...
  return (
    <div className='p-8'>
      ...
      <div className='mb-6'>
        ...
        <div className='text-sm text-gray-500 mt-3'>Showing 8 of 8 logs</div>
      </div>
              ...
              {logs.map((log, index) => {
                ...
                return (
                  <tr key={index} className='hover:bg-gray-50'>
                    ...
                    <td className='px-6 py-4 text-sm text-gray-900 whitespace-nowrap'>{log.timestamp}</td>
                    <td className='px-6 py-4'>
                    ...
                    <td className='px-6 py-4 text-sm text-gray-900'>{log.userClient}</td>
