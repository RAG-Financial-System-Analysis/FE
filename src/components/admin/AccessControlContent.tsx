    ...
    <div className='p-8'>
      ...
      {activeTab === 'Roles & Permissions' && (
        <div>
          ...
          <div className='mb-6'>
            <h2 className='text-xl font-bold text-gray-900 mb-1'>Available Permissions</h2>
            <p className='text-sm text-gray-500'>System-wide permission categories</p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {permissions.map((permission, index) => (
              <div key={index} className='bg-white rounded-xl border border-gray-200 p-6'>
                <h3 className='text-lg font-semibold text-gray-900 mb-4'>{permission.category}</h3>
