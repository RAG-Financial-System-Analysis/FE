          ...
          <div className='flex justify-between items-center mb-10'>
            <div className='flex items-center gap-3'>
              ...
              <div>
                ...
                <p className='text-slate-600 mt-1'>Manage and analyze your uploaded PDF disclosures</p>
              </div>
            </div>
            ...
            <div className='flex gap-4'>
              <div className='relative'>
                ...
                <Input
                  ...
                  className='pl-10 w-64 bg-white/80 backdrop-blur-sm border-slate-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200'
                  value={searchText}
            ...
            <div className='lg:col-span-1'>
              <div className='bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-white/20'>
                <div className='flex items-center gap-3 mb-6'>
                  ...
                  <h3 className='text-xl font-semibold text-slate-900'>Upload Report</h3>
                </div>
                ...
                <form onSubmit={handleUpload} className='space-y-6'>
                  <div>
                    ...
                    <select
                      ...
                      className='w-full bg-white/80 backdrop-blur-sm border border-slate-300 text-slate-700 text-sm rounded-xl p-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200'
