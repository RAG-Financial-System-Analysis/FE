            ...
            <div className="w-full flex items-center justify-between px-6 md:px-10 h-20">
                ...
                <a href="#" className="flex items-center gap-2 group cursor-pointer">
                    <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center shadow-lg transition-transform group-hover:scale-105">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18" /><path d="M18.7 8l-5.1 5.2-2.8-2.7L7 14.3" /></svg>
                    </div>
                    <span className="font-outfit font-bold text-lg text-primary tracking-tight hidden sm:inline-block">FinanceAI</span>
                </a>
                ...
                <div>
                    <Button
                        ...
                        className="bg-[#2A4069] hover:bg-primary-dark text-white px-8 h-11 rounded-md font-semibold text-sm transition-all shadow-md active:scale-95"
                    >
                        Login
                    </Button>
                </div>
