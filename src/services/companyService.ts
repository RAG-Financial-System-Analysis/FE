        ...
        try {
            ...
            if (symbol.toUpperCase() === 'FPT') {
                return {
                    ...
                    stockTrend: [
                        { label: "Jan", price: 62000 }, { label: "Feb", price: 65000 },
                        { label: "Mar", price: 68000 }, { label: "Apr", price: 70000 },
                        { label: "May", price: 73000 }, { label: "Jun", price: 75000 },
                        { label: "Jul", price: 78000 }, { label: "Aug", price: 72000 },
                        { label: "Sep", price: 76000 }, { label: "Oct", price: 80000 },
                        { label: "Nov", price: 83000 }, { label: "Dec", price: 86000 }
                    ],
                    revenueStructure: [
                    ...
                    analysis: {
                        strengths: "FPT maintains high growth in the IT sector with 15.2% revenue growth in 2023. The company is expanding strongly into international markets with major projects in Japan and Europe.",
                        opportunities: "Global digital transformation trend creates many opportunities for FPT to expand market share, especially in AI, Cloud Computing, and enterprise technology solutions.",
                        risks: "Fierce competition in the technology industry and global market volatility may affect business performance. Rising labor costs also pose management challenges."
                    }
                };
            }
            ...
            if (symbol.toUpperCase() === 'VNM') {
                return {
                    ...
                    stockTrend: [
                        { label: "Jan", price: 78000 }, { label: "Feb", price: 76000 },
                        { label: "Mar", price: 80000 }, { label: "Apr", price: 77000 },
                        { label: "May", price: 81000 }, { label: "Jun", price: 79000 },
                        { label: "Jul", price: 83000 }, { label: "Aug", price: 81000 },
                        { label: "Sep", price: 84000 }, { label: "Oct", price: 82000 },
                        { label: "Nov", price: 85000 }, { label: "Dec", price: 87000 }
                    ],
                    revenueStructure: [
                    ...
                    analysis: {
                        strengths: "Vinamilk is the leading company in food & beverage with high ROE of 28.3%. The company has an extensive distribution system and a trusted brand recognized by Vietnamese consumers.",
                        opportunities: "Vietnam's dairy market continues to grow well with a young population and trend toward nutritional products. Vinamilk has opportunities to expand into Southeast Asian export markets.",
                        risks: "Competition from foreign brands and changing consumer habits may affect market share. Raw material price fluctuations also impact profit margins."
                    }
                };
            }
