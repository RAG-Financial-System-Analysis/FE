    ...
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-[#f6f6f8] dark:bg-[#101622] font-['Inter']">
        ...
        <div className="relative z-20 flex flex-col justify-between p-12 text-white w-full">
          ...
          <div className="max-w-md">
            <h1 className="text-4xl font-bold leading-tight mb-4">
              Precision in Financial Evaluation
            </h1>
            <p className="text-lg text-white/80 leading-relaxed">
              Access comprehensive ratio-based analysis tools and institutional
              corporate datasets designed for academic financial research.
            </p>
          </div>

          <div className="text-sm text-white/60">
            © 2024 Academic Financial Systems. All rights reserved.
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-white dark:bg-[#101622] px-6 py-12 lg:px-20">
        ...
        <div className="lg:hidden absolute top-8 left-8 flex items-center gap-2">
          ...
          <span className="text-lg font-bold text-[#101622] dark:text-white">
            Analyst Portal
          </span>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <a
            href="/"
            className="inline-block mb-6 text-sm font-semibold text-[#0f49bd] hover:underline"
          >
            ← Back to Home
          </a>

          <div className="mb-10">
            <h2 className="text-[#0d121b] dark:text-white text-[32px] font-bold leading-tight">
              Welcome Back
            </h2>
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-[#4c669a] dark:text-gray-400 font-medium">
                  Remember me
                </span>
              </label>
              <a
                href="#"
                className="text-sm font-semibold text-[#0f49bd] hover:underline"
              >
                Forgot password?
              </a>
            </div>
