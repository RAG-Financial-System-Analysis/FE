...
function HomePage() {
  ...
  const footerLinks = ['IFRS S1 & S2 Compliance', 'GAAP Taxonomy', 'XBRL Data Mapping', 'Ethical AI Framework']
  ...
  return (
    <div className='relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden bg-[#f6f7f8] dark:bg-[#111921] text-[#0e141b] dark:text-slate-50'>
      ...
      <header className='flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e7edf3] dark:border-b-slate-700 px-10 py-3 bg-white dark:bg-[#111921] sticky top-0 z-50'>
        ...
        <div className='flex flex-1 justify-end gap-8'>
          <div className='flex items-center gap-9'>
            <a
              className='text-[#0e141b] dark:text-white text-md font-medium leading-normal hover:text-primary transition-colors'
              href='#'
            >
              Methodology
            </a>
      ...
      <motion.section
        ...
        variants={fadeInUp}
        className='flex flex-col items-center justify-center py-20 px-4 text-center bg-slate-900 relative overflow-hidden'
      >
        ...
        <div className='relative z-10 max-w-4xl'>
          ...
          <p className='text-slate-300 text-lg font-normal leading-relaxed max-w-2xl mx-auto mb-10'>
            Empowering academic research with quantitative precision through automated financial evaluation and
            standardized ratio heuristics.
          </p>
      ...
      <motion.section
        ...
        className='max-w-[1200px] mx-auto w-full px-10 py-20'
      >
        <div className='flex flex-col gap-10'>
          <motion.div variants={fadeInUp} className='flex flex-col gap-4 border-l-4 border-[#1773cf] pl-6'>
            ...
            <p className='text-[#4e7397] dark:text-slate-400 text-lg max-w-3xl'>
              Traditional research methods often struggle with scalability and rigor. Our system addresses these
              systemic barriers to empirical validity.
            </p>
          </motion.div>
            ...
            {problems.map((problem, index) => (
              ...
              >
                ...
                <div className='flex flex-col gap-2'>
                  <h3 className='text-[#0e141b] dark:text-white text-xl font-bold'>{problem.title}</h3>
                  <p className='text-[#4e7397] dark:text-slate-400 leading-relaxed'>{problem.description}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      >
        <div className='max-w-[1200px] mx-auto px-10'>
          <motion.h2
            variants={fadeInUp}
            className='text-[#0e141b] dark:text-white text-2xl font-bold mb-10 text-center uppercase tracking-widest'
          >
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
            {capabilities.map((capability, index) => (
              ...
              >
                ...
                <h4 className='text-[#0e141b] dark:text-white font-bold text-lg mb-2'>{capability.title}</h4>
                <p className='text-[#4e7397] dark:text-slate-400 text-sm'>{capability.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <motion.section
        ...
        viewport={{ once: false, amount: 0.2 }}
        variants={fadeInUp}
        className='py-20 max-w-[1200px] mx-auto px-10'
      >
      ...
      <motion.section
        ...
        viewport={{ once: false, amount: 0.2 }}
        variants={fadeInUp}
        className='bg-slate-100 dark:bg-slate-900/50 py-20 px-10'
      >
          ...
          <div className='bg-white dark:bg-slate-800 rounded-xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-700 flex flex-col lg:flex-row'>
            ...
            <div className='flex-1 p-8 border-r border-slate-200 dark:border-slate-700'>
              <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4'>
                <div>
                  <h3 className='text-xl font-bold text-[#0e141b] dark:text-white'>Profitability Benchmark Analysis</h3>
            ...
            <div className='w-full lg:w-96 bg-slate-50 dark:bg-slate-800/50 p-8'>
              ...
              <div className='space-y-6'>
                <motion.div
                  ...
                  className='p-4 bg-white dark:bg-slate-700 rounded-lg border-l-4 border-[#1773cf] shadow-sm'
                >
                  ...
                  <p className='text-sm text-[#0e141b] dark:text-slate-200'>
                    The narrowing gap suggests efficient capital allocation and reduced reliance on financial leverage
                    for equity returns.
                  </p>
                </motion.div>
                <motion.div
                  ...
                  className='p-4 bg-white dark:bg-slate-700 rounded-lg border-l-4 border-slate-300 shadow-sm'
                >
        ...
        <div className='max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12'>
          ...
          <div className='col-span-1 md:col-span-2 bg-slate-800/50 p-8 rounded-xl border border-slate-700'>
            ...
            <p className='text-xs leading-relaxed text-slate-400 italic'>
              The outputs generated by this system are for academic research and educational purposes only. This
              platform does not provide financial advice, audit opinions, or investment recommendations. All ratio
              calculations are performed in strict alignment with IFRS and US-GAAP standards where indicated.
              Researchers are encouraged to verify AI-assisted qualitative interpretations against source filings.
            </p>
          </div>
          <div className='col-span-1'>
